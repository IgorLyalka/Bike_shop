...
<body>
   <div style="text-align: center;">
      ...
      <?php if (!empty($_SESSION["login"])) : ?>
         ...
         <?php
         $sql = $pdo->prepare("SELECT * FROM important");
         $sql->execute();
         while ($res = $sql->fetch(PDO::FETCH_OBJ)) : ?>
            <form action="/admin/seveadminpanel/important/important.php/<?php echo $res->id?>" method="post" enctype="multipart/form-data">
               <?php echo $res->id?><br>
               <br>
               ...
               <br>
               <p> <img style="background-color:blanchedalmond; widht:200px; height:200px" src="/images/<?php echo $res->image ?>" alt=""></p>
